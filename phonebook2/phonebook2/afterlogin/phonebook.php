...
$stmt = $con->prepare('SELECT name, email FROM login WHERE id = ?');
    ...
    <div class="container">
        ...
        <div class="main-content">
            ...
            <div class="projects-container">
                <div class="projects-header main-content-header">Phonebook Contacts</div>
                <div class="projects">
                    <?php
                    include_once("config.php");
                    $sql = "SELECT `id`, `first_name`, `last_name`, `address`, `phone_number`, `email` FROM `contacts` WHERE 1";
                    ...
                    ?>
                        ...
                        <div class="project-card card">
                            <a href="">
                                <div class="card-title"> <?php echo $record['first_name']; ?> <?php echo $record['last_name']; ?></div>
                                <div class="card-text"> 
                                    Email:  <?php echo $record['email']; ?><br>
                                    Phone Number :  <?php echo $record['phone_number']; ?> <br>
